	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
				//alert("自己做");
				$("#captchaImage").prop("src","${pageContext.request.contextPath}/admin/createImg?time="+new Date());
			});
            //  form 表单提交
				...
				<table>
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/admin/createImg" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
					...
					<tr>
						...
						<td>
                            ...
                            <input type="submit" class="loginButton" id="btns" value="登录">
